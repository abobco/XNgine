...
uniform vec2 res;        // Dimensions of the screen
...
void main()
{
    ...
    *************************************************************************************************/
    ...
    vec2 z = vec2((fragTexCoord.x + offset.x/res.x)*2.5/zoom, (fragTexCoord.y + offset.y/res.y)*1.5/zoom);
    ...
    else gl_FragColor = vec4(Hsv2rgb(vec3((mod(iColorOffset - norm, 1.0)), 1.0, 1.0)), 1.0);
}
